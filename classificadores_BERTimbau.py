...
"""Códogo referente aos classificadores SVM e RF usando a matriz de embeddings gerada pelo BERTimbau, e com smote"""
...
def salvModel(modelo, nome, X_train, y_train, X_test, y_test):
  ...
  pickle.dump(X_train, open('B_1005/' + nome + 'X_train_bert_0905_B.pickle', 'wb'))
  pickle.dump(y_train, open('B_1005/' + nome + 'y_train_bert_0905_B.pickle', 'wb'))
  pickle.dump(X_test, open('B_1005/' + nome + 'X_test_bert_0905_B.pickle', 'wb'))
  pickle.dump(y_test, open('B_1005/' + nome + 'y_test_bert_0905_B.pickle', 'wb'))
  pickle.dump(y_pred, open('B_1005/' + nome + 'y_pred_bert_0905_B.pickle', 'wb'))
...
df_metricas = metricas(rf_clf, 'RF-BERTimbau', X_test, y_test, df_metricas)
...
df_metricas = metricas(rf_clf, 'RF-BERTimbau-SMOTE', X_test, y_test, df_metricas)
...
df_metricas = metricas(SupportVM, 'SVM-BERTimbau', X_test, y_test, df_metricas)
...
df_metricas = metricas(SupportVM, 'SVM-BERTimbau-SMOTE', X_test, y_test, df_metricas)

df_metricas

df_metricas.to_csv('metricasBERTimbau0506.csv')