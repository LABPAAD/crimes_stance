...
"""Códogo referente a estratégia de ajuste fino da rede neural usando o modelo Multilingual"""
...
for epoch in range(EPOCHS):
  ...
  if train_acc > best_accuracy:
    torch.save(model.state_dict(),'geral_Multilingual_base_atuali_best_model_state.bin')
...
df_metricas = metricas(y_pred, 'Rede-neural-multilingual', y_test, df_metricas)

df_metricas.to_csv('metricas_rede_neural_Multilingual_base.csv')
